document.addEventListener('DOMContentLoaded', () => {
    ...
    const totalTravelCostOutput = document.getElementById('totalTravelCost'); // This will still show the total including daily expenses
    ...
    function calculateTravelCosts() {
        ...
        // The total cost displayed on the main page will still include daily expenses
        const totalCostOnPage = totalHotelCost + dailyAllowance + totalDailyExpenses;
        totalTravelCostOutput.textContent = totalCostOnPage.toFixed(2);
    }
    ...
    generateReportButton.addEventListener('click', () => {
        ...
        // const totalTravelCost = parseFloat(totalTravelCostOutput.textContent); // This is the old total including daily expenses
        ...
        // Calculate "Überweisungsbetrag"
        const transferAmount = totalHotelCost + dailyAllowanceDetails;

        reportContent += `<p>---</p>`;
        reportContent += `<p><strong>Überweisungsbetrag (Hotel + Pauschalen):</strong> ${transferAmount.toFixed(2)} €</p>`;

        // Removed the old line: <p><strong>Gesamtbetrag Reisekosten (Hotel + Pauschalen + Tagesausgaben):</strong> ${totalTravelCost.toFixed(2)} €</p>
